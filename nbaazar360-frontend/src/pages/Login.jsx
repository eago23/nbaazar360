      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 mb-6">
            ...
            <span className="font-semibold text-2xl text-secondary">Bazaar360</span>
          </Link>
          <h1 className="text-2xl font-bold text-secondary">Mirësevini përsëri</h1>
          <p className="text-gray-600 mt-2">Hyni në llogarinë tuaj</p>
        </div>

        {/* Form */}
        <div className="bg-white rounded-xl shadow-sm p-8">
          {error && (
            <div className="mb-6 p-4 bg-red-50 border-2 border-red-400 rounded-xl flex items-start justify-between animate-shake">
