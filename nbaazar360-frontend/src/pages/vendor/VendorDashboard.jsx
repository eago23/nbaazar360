    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 p-6">
          ...
          <p className="text-gray-600">Histori Totale</p>
        </div>
        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 p-6">
          ...
          <p className="text-gray-600">Të Publikuara</p>
        </div>
        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 p-6">
          ...
          <p className="text-gray-600">Shikime Totale</p>
        </div>
      </div>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            ...
            className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-primary hover:bg-red-50 transition-all"
          >
          ...
          <Link
            ...
            className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-purple-500 hover:bg-purple-50 transition-all"
          >
          ...
          <Link
            to="/tregtar/profili"
            className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-green-500 hover:bg-green-50 transition-all"
          >
      ...
      <div>
        ...
        {loading ? (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="ml-4 flex items-center space-x-2 px-4 py-2 border-2 border-gray-200 rounded-lg hover:border-primary hover:bg-red-50 transition-all"
                  >
                    <Edit size={18} />
                    <span className="font-medium">Ndrysho</span>
                  </Link>
                </div>
              </div>
            ))}
          ...
          <div className="bg-white rounded-xl border-2 border-gray-200 p-12 text-center">
            ...
            <Link
              to="/tregtar/historite/e-re"
              className="inline-flex items-center space-x-2 px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary-dark transition-colors font-semibold"
            >
              <Plus size={20} />
              <span>Krijo Historinë e Parë</span>
            </Link>
          </div>
        )}
      </div>
