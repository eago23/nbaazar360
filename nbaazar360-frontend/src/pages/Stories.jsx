...
function Stories() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-10 sm:py-16 md:py-20 bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-secondary mb-2 sm:mb-3">
              Si Funksionon
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12">
            {steps.map((step) => (
              <div key={step.number} className="text-center">
                {/* Icon */}
                <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 mb-4 sm:mb-6 bg-gradient-to-br from-primary to-primary-dark rounded-xl sm:rounded-2xl shadow-lg">
                  <step.icon className="text-white" size={28} />
                </div>

                {/* Number Badge */}
                <div className="inline-block px-3 sm:px-4 py-1 bg-gray-900 text-white text-sm sm:text-base font-bold rounded-full mb-3 sm:mb-4">
                  {step.number}
                </div>
      ...
      <section className="py-10 sm:py-16 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          {/* Title */}
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-secondary mb-6 sm:mb-8 md:mb-12">
            Energjia e Pazarit
          </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {stories.map((story) => (
                <Link
                  ...
                  className="group bg-white rounded-xl border-2 border-gray-200 overflow-hidden hover:shadow-xl hover:border-gray-300 sm:hover:scale-[1.02] transition-all duration-300"
                >
                  {/* Thumbnail - Compact */}
                  ...
                  <div className="p-4">
                    {/* Title: vendor story = business_name, admin story = title OR truncated description */}
                    <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-primary transition-colors line-clamp-1">
                      {story.vendor_id
                        ? (story.business_name || 'Histori AR')
          ...
          {!loading && !error && stories.length === 0 && (
            <div className="text-center py-12 sm:py-20">
              <Smartphone size={48} className="mx-auto text-gray-400 mb-4 sm:w-16 sm:h-16" />
